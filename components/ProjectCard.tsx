      ...
      {hasImage && (
        <div className="relative w-full aspect-[16/9] bg-[var(--surface-3)] overflow-hidden">
          {!imageError ? (
            ...
            <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-[rgba(255,179,71,0.2)] to-[rgba(45,212,191,0.25)]">
              <svg className="w-16 h-16 text-[rgba(255,179,71,0.35)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {project.tags.map((tag) => (
                <span
                  key={tag}
                  className="px-3 py-1 text-xs font-medium bg-[var(--surface-2)] text-[var(--muted)] rounded-full"
                >
                  {tag}
                </span>
              ))}
            ...
            <div className="flex gap-4">
              {project.link && (
                <Link
                  ...
                  className="inline-flex items-center gap-2 text-sm font-medium text-[var(--accent)] hover:text-[var(--accent-strong)] transition-colors"
                >
