      ...
      <div className="mb-12 grid md:grid-cols-[1.1fr_0.9fr] gap-10 items-center">
        <div>
          ...
          <p className="text-[var(--muted)] text-lg mt-3 max-w-2xl">
            Platform engineer building calm, reliable infrastructure. Selected work in Kubernetes, CI/CD, and
            cloud automation.
          </p>
        </div>
        <div className="surface-card rounded-3xl p-6 flex items-center gap-4">
          ...
          <div>
            <p className="text-lg font-display text-[var(--foreground)]">Platform Engineer</p>
